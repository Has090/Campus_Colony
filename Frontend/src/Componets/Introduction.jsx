  ...
  return (
    <div className="bg-[#1e272e] text-white p-12 flex flex-col md:flex-row items-center justify-between rounded-3xl border-b-8 border-[#ff5e57] shadow-2xl">
      ...
      <div className="max-w-xl">
        ...
        <p className="text-gray-400 mb-8 text-lg font-medium border-l-4 border-gray-600 pl-4">
          Find hostels, flats & homes within 5 km of your college in Lahore.<br />
          Get real area intelligence before you decide.
        </p>
        
        <div className="flex gap-4 mb-10">
          <button className="bg-[#ff5e57] hover:bg-[#ff3f34] text-white px-10 py-4 font-bold uppercase transition-all shadow-lg">
            Explore Rentals
          </button>
          <button className="border-2 border-gray-600 hover:border-white text-white px-10 py-4 font-bold uppercase transition-all">
            Area Insights
          </button>
        </div>

        {/* Stats */}
        <div className="flex gap-12 pt-8 border-t border-gray-700">
          <div>
      ...
      <div className="relative mt-12 md:mt-0">
        <div className="bg-gray-800 p-2 shadow-2xl rotate-2">
           <img src="/intro.png" alt="Map" className="w-[450px] grayscale hover:grayscale-0 transition-all duration-500" />
        </div>
        
        <div className="absolute -bottom-6 -left-10 bg-white p-6 text-black border-4 border-[#ff5e57] -rotate-2">
          <p className="font-black text-2xl uppercase italic leading-none">Faisal Town</p>
          <p className="text-xs font-bold mt-1 text-gray-600 tracking-tighter uppercase">Area Score: 86/100</p>
        </div>
      </div>
